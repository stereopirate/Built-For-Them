...
- Adaptive Positioning Bench — V1 project page (drill-hole version)
...
- `assets/images/`
- `assets/downloads/adaptive-positioning-bench-v1-build-guide.pdf`
- `assets/downloads/adaptive-positioning-bench-v2-build-guide.pdf`
- `projects/index.html` — directory page listing all published projects
- `projects/adaptive-positioning-bench-v1/index.html`
